...
이 디렉토리(docs/LST/)에 포함된 모든 문서(*.md)는
...
본 문서들은 프로젝트의 기획, 기능 정의, 구조 설계 등
일반 코드와는 별도의 저작권 및 공개 정책이 필요하기 때문에
독립된 라이선스를 사용합니다.

해당 폴더에 있는 문서들은 추후 v2에서 적용될 프로젝트입니다.

## 📜 License

이 폴더의 문서에 적용되는 라이선스는
동일한 디렉토리에 포함된 [LICENSE](LICENSE) 파일을 확인해 주세요.
